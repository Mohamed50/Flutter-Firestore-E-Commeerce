...
// in getx_example/test/unit/auth-view-model-test.dart.
...
class _FakeSettings_9 extends _i1.Fake implements _i7.Settings {}

class _FakeCollectionReference_10<T extends Object?> extends _i1.Fake
    implements _i8.CollectionReference<T> {}

class _FakeWriteBatch_11 extends _i1.Fake implements _i8.WriteBatch {}

class _FakeLoadBundleTask_12 extends _i1.Fake implements _i8.LoadBundleTask {}
...
class MockFacebookLogin extends _i1.Mock implements _i2.FacebookLogin {
  ...
  bool get debug =>
      (super.noSuchMethod(Invocation.getter(#debug), returnValue: false)
          as bool);
  @override
  _i9.Future<_i2.FacebookAccessToken?> get accessToken =>
      (super.noSuchMethod(Invocation.getter(#accessToken),
              returnValue: Future<_i2.FacebookAccessToken?>.value())
          as _i9.Future<_i2.FacebookAccessToken?>);
  @override
  _i9.Future<String> get sdkVersion =>
  ...
  @override
  _i9.Future<_i2.FacebookUserProfile?> getUserProfile() =>
      (super.noSuchMethod(Invocation.method(#getUserProfile, []),
              returnValue: Future<_i2.FacebookUserProfile?>.value())
          as _i9.Future<_i2.FacebookUserProfile?>);
  @override
  _i9.Future<String?> getProfileImageUrl({int? width, int? height}) =>
      (super.noSuchMethod(
          Invocation.method(
              #getProfileImageUrl, [], {#width: width, #height: height}),
          returnValue: Future<String?>.value()) as _i9.Future<String?>);
  @override
  _i9.Future<String?> getUserEmail() =>
      (super.noSuchMethod(Invocation.method(#getUserEmail, []),
          returnValue: Future<String?>.value()) as _i9.Future<String?>);
  @override
  _i9.Future<_i2.FacebookLoginResult> logIn(
          {List<_i10.FacebookPermission>? permissions = const [
            _i10.FacebookPermission.publicProfile
          ],
      ...
      (super.noSuchMethod(
          ...
          as _i9.Future<_i2.FacebookLoginResult>);
  @override
  _i9.Future<_i2.FacebookLoginResult> expressLogin() =>
...
class MockFirebaseFirestore extends _i1.Mock implements _i8.FirebaseFirestore {
  ...
  set app(_i4.FirebaseApp? _app) =>
      super.noSuchMethod(Invocation.setter(#app, _app),
          returnValueForMissingStub: null);
  @override
  set settings(_i7.Settings? settings) =>
  ...
  _i7.Settings get settings => (super.noSuchMethod(Invocation.getter(#settings),
      returnValue: _FakeSettings_9()) as _i7.Settings);
  @override
  Map<dynamic, dynamic> get pluginConstants =>
      (super.noSuchMethod(Invocation.getter(#pluginConstants),
          returnValue: <dynamic, dynamic>{}) as Map<dynamic, dynamic>);
  ...
  @override
  _i8.WriteBatch batch() => (super.noSuchMethod(Invocation.method(#batch, []),
      returnValue: _FakeWriteBatch_11()) as _i8.WriteBatch);
  @override
  ...
  _i9.Future<void> enablePersistence(
      ...
      (super.noSuchMethod(
          ...
          returnValueForMissingStub: Future<void>.value()) as _i9.Future<void>);
  @override
  _i8.LoadBundleTask loadBundle(_i12.Uint8List? bundle) =>
      (super.noSuchMethod(Invocation.method(#loadBundle, [bundle]),
          returnValue: _FakeLoadBundleTask_12()) as _i8.LoadBundleTask);
  @override
  ...
  _i9.Future<_i8.QuerySnapshot<Map<String, dynamic>>> namedQueryGet(
      ...
      (super.noSuchMethod(
          ...
          returnValue: Future<_i8.QuerySnapshot<Map<String, dynamic>>>.value(
              _FakeQuerySnapshot_13<Map<String, dynamic>>())) as _i9
          .Future<_i8.QuerySnapshot<Map<String, dynamic>>>);
  @override
  ...
  @override
  _i9.Future<T> runTransaction<T>(_i8.TransactionHandler<T>? transactionHandler,
          {Duration? timeout = const Duration(seconds: 30)}) =>
      (super.noSuchMethod(
          Invocation.method(
...
class MockCollectionReference<T extends Object?> extends _i1.Mock
  ...
  _i8.FirebaseFirestore get firestore =>
      (super.noSuchMethod(Invocation.getter(#firestore),
          returnValue: _FakeFirebaseFirestore_16()) as _i8.FirebaseFirestore);
  @override
  ...
  _i9.Future<_i8.DocumentReference<T>> add(T? data) =>
      (super.noSuchMethod(Invocation.method(#add, [data]),
              returnValue: Future<_i8.DocumentReference<T>>.value(
  ...
  _i8.DocumentReference<T> doc([String? path]) => (super.noSuchMethod(
      ...
      returnValue: _FakeDocumentReference_15<T>()) as _i8.DocumentReference<T>);
  @override
  _i8.CollectionReference<R> withConverter<R extends Object?>(
          {_i8.FromFirestore<R>? fromFirestore,
          _i8.ToFirestore<R>? toFirestore}) =>
      (super.noSuchMethod(
  ...
  _i8.Query<T> endAtDocument(_i8.DocumentSnapshot<Object?>? documentSnapshot) =>
      (super.noSuchMethod(Invocation.method(#endAtDocument, [documentSnapshot]),
          returnValue: _FakeQuery_14<T>()) as _i8.Query<T>);
  @override
  _i8.Query<T> endAt(List<Object?>? values) =>
  ...
  _i8.Query<T> endBeforeDocument(
      ...
      (super.noSuchMethod(
          ...
          returnValue: _FakeQuery_14<T>()) as _i8.Query<T>);
  @override
  _i8.Query<T> endBefore(List<Object?>? values) =>
  ...
  _i9.Future<_i8.QuerySnapshot<T>> get([_i7.GetOptions? options]) =>
      (super.noSuchMethod(Invocation.method(#get, [options]),
          returnValue: Future<_i8.QuerySnapshot<T>>.value(
              _FakeQuerySnapshot_13<T>())) as _i9.Future<_i8.QuerySnapshot<T>>);
  @override
  ...
  _i9.Stream<_i8.QuerySnapshot<T>> snapshots(
      ...
      (super.noSuchMethod(
              ...
              returnValue: Stream<_i8.QuerySnapshot<T>>.empty())
  ...
  _i8.Query<T> startAfterDocument(
      ...
      (super.noSuchMethod(
          ...
          returnValue: _FakeQuery_14<T>()) as _i8.Query<T>);
  @override
  _i8.Query<T> startAfter(List<Object?>? values) =>
  ...
  _i8.Query<T> startAtDocument(
      ...
      (super.noSuchMethod(
          ...
          returnValue: _FakeQuery_14<T>()) as _i8.Query<T>);
  @override
  _i8.Query<T> startAt(List<Object?>? values) =>
      (super.noSuchMethod(Invocation.method(#startAt, [values]),
          returnValue: _FakeQuery_14<T>()) as _i8.Query<T>);
  @override
  _i8.Query<T> where(Object? field,
          {Object? isEqualTo,
          Object? isNotEqualTo,
          Object? isLessThan,
